...
class AnalyticsService:
    ...
    def get_top_happy_words_chart(self, limit: int = 10) -> TopHappyWordsChart:
        ...
        stopwords = {
            ...
            "too", "very", "can", "will", "just", "should", "now", "ain",
            "aren", "couldn", "didn", "doesn", "hadn", "hasn", "haven", "isn",
            "mightn", "mustn", "needn", "shan", "shouldn", "wasn", "weren",
            "won", "wouldn", "don", "s", "t", "d", "ll", "m", "o", "re", "ve",
            # domain-specific filler words for happiness notes
            "got", "day", "today", "me", "really", "so", "time", "received",
            "something", "felt", "spent", "went", "made", "feel", "make",
            "also", "even", "still", "well", "much", "many", "one", "two",
            "new", "good", "great", "nice", "little", "long", "last", "first",
            "night", "evening", "morning", "week", "get", "come", "back",
            "know", "said", "came", "took", "had", "it",
        }
